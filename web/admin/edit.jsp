    ...
    <div class="edit_content">
        <form action="${ctx }/GoodsServlet?action=updateGoods" method="post" id="edit_form" style="background: none; width: 700px;">
            ...
            <div class="item1 item_desc">
                <span>商品描述：</span>
                <textarea id="desc" name="demc" rows="4" cols="50">${goods.demc }</textarea>
            </div>
...
<script>
    ...
    $(function () {
        ...
        $("#edit").click(function () {
            //让表单提交 GoodsServlet(upateGoods)
            //获取表单  让其提交
            $("#edit_form").submit();
        });

        //让value的值等于商品is_hot的option成为选中状态
        $("#isHotSel option[value=${goods.ishot}]").prop("selected", true);
