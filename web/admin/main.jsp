...
<div class="goods_list">
    ...
    <c:forEach items="${pageBean.goodsList }" var="goods" varStatus="status">
        ...
        <ul class="list_goods_ul">
            ...
            <li><img src="${pageContext.request.contextPath }/admin/images/pimages/${goods.image}"></li>
            <li>${goods.name }</li>
            <li>${goods.price }</li>
            <li><a href="${pageContext.request.contextPath }/GoodsServlet?action=updateUIGoods&id=${goods.id}"><img
                    class="img_icon"
                    src="${pageContext.request.contextPath}/admin/images/edit_icon.png"></a>
            </li>
            <li><a href="${pageContext.request.contextPath }/GoodsServlet?action=delGoods&id=${goods.id}"><img
                    class="img_icon"
